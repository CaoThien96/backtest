...
export const PrpPivotPsarStrategy = {
  ...
  paramSchema: {
    ...
    slMultiplier: { type: "number", label: "SL ATR", default: 8.8, min: 0.1, max: 20, step: 0.1 },
    tpMultiplier: { type: "number", label: "TP ATR", default: 8.8, min: 0.1, max: 50, step: 0.1 },
    ...
    rvolLookback: { type: "number", label: "Lookback", default: 5, min: 1, max: 200 },
